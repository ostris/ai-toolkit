...
import { Home, Settings, BrainCircuit, Images, Plus, Menu, X } from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <button
        className="md:hidden fixed top-0 left-0 z-50 h-12 w-12 flex items-center justify-center text-gray-300 hover:text-white"
      ...
      <div
        className={`
          flex flex-col w-64 bg-gray-900 text-gray-100 h-screen
