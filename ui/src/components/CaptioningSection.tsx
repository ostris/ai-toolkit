...
const EXTRA_OPTIONS = [
  ...
  'Do NOT include information about people/characters that cannot be changed (like ethnicity, gender, etc), but do still include changeable attributes (like hair style, hair color, clothes, etc).',
  'Include information about lighting.',
  'Include information about camera angle.',
  'Include information about whether there is a watermark or not.',
  'Include information about whether there is text or not.',
  'If it is a photo, include information about what camera was likely used and camera settings.',
  'Include information about art style.',
  'Include information about what kind of media this is.',
  'Ignore artistic style and focus on the content.',
  'Only mention the most important elements.',
  'If there is a person/character in the image you must refer to them as {name}. Do NOT use pronouns.',
  'Don\'t identify real people, celebrities, or public figures.',
  'Only mention colors for unexpected things.',
  'Reply as if you are the character in the image.',
  'Describe the image as if it were a movie scene.',
  'Describe the image as if it were a painting.',
  'Describe the image as if it were a photograph.',
  'Describe the image as if it were a drawing.',
  'Describe the image as if it were a 3D render.',
  'Describe the image as if it were a screenshot from a video game.',
  'Describe the image as if it were a screenshot from an anime.',
  'Describe the image as if it were a screenshot from a movie.',
  'Describe the image as if it were a screenshot from a TV show.',
  'The image is NSFW.',
  'The image is SFW.'
];
