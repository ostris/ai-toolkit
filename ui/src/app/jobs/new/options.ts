...
export const quantizationOptions: SelectOption[] = [
  ...
  { value: 'convrotint7', label: '7bit convrot int' },
  { value: 'convrotint6', label: '6bit convrot int' },
  { value: 'convrotint5', label: '5bit convrot int' },
  { value: 'convrotint4', label: '4bit convrot int' },
  { value: 'convrotint3', label: '3bit convrot int' },
  { value: 'convrotint2', label: '2bit convrot int' },
