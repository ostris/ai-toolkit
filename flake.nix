      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo ""
            echo "Quick start:"
            echo "  1. Setup Python environment with Nightly:"
            echo "     setup-venv-stable"
            echo "     Run setup-venv-nightly if you are using a Blackwell GPU"
            echo ""
            echo "  2. Activate environment (in new shells):"
            echo "     activate-venv"
            echo ""
            echo "  3. Configure your training job in config/"
            echo ""
            echo "  4. Run training:"
